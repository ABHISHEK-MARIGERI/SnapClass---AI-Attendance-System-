...
def teacher_screen_login():
    ...
    teacher_username = st.text_input("Enter username",placeholder='abhishek',key="teacher_login_username")
...
def teacher_screen_register():
    ...
    teacher_username = st.text_input("Enter username",placeholder='@abhishek',key="teacher_register_username")

    teacher_name = st.text_input("Enter name",placeholder='abhishek',key="teacher_register_name")
